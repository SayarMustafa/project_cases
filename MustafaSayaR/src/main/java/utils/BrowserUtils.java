...
public class BrowserUtils {
	...
	public static void clickWithJavaScript(WebElement element) {
		...
		// JavaScriptExecutor kullanarak tıklama işlemi
		JavascriptExecutor js = (JavascriptExecutor) DriverManager.getDriver();
		js.executeScript("arguments[0].click();", element);
	}

	public static void changeValueWithJavaScript(WebElement element, String newValue) {

		// JavaScriptExecutor kullanarak value'yu değiştir
		JavascriptExecutor js = (JavascriptExecutor) DriverManager.getDriver();
